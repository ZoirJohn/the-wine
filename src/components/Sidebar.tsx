        ...
        return (
                <>
                        <aside className='relative max-w-[230px] lg:w-full max-md:w-full max-md:'>
                                ...
                                {isOpenFilter && (
                                        <div className='bg-brownie z-10 w-full overflow-scroll max-md:h-screen max-md:fixed max-md:top-0 max-md:left-1/2 max-md:-translate-x-1/2 max-md:p-4 max-md:pt-8 '>
                                                <span
